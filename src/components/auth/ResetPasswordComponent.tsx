...
const ResetPasswordComponent = () => {
    ...
    const [isReset,setIsRegister]=useState(false)

    return (
        <View style={styles.container}>
            <WrapperContainer backgroundImage={Images.authBackground} label={'Reset Password'} description="Enter a new password below and you'll be back in your account in no time.">
                <CustomTextInput
                    placeholder="Enter Email"
                    inputStyle={{ marginVertical: 10, marginTop: 30 }} />
                <CustomButton description="Reset Password" containerStyle={{ backgroundColor: Colors.buttonColor }} onPress={() => navigation.navigate(RoutesConfig.RESET_PASSWORD)} />
